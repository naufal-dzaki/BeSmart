...
@section('DashboardContent')
    ...
    <a href="/dashboard/task/create" class="btn btn-active btn-primary"><i data-feather="file-plus"
                    ...
                    <tr>
                        ...
                        <td class="flex">
                            ...
                            <div class="bg-blue-400 p-1.5 mr-1 rounded-full">
                                <a href="/dashboard/task/{{ $post->slug }}"
                            ...
                            <div class="bg-yellow-400 p-1.5 mr-1 rounded-full">
                                <a href="/dashboard/task/{{ $post->slug }}/edit"
