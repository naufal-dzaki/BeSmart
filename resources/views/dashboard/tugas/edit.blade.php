...
@section('DashboardContent')
    <h1 class="text-3xl text-black pb-4">Edit Tugas</h1>

    <div class="form-control ">
        <form method="post" action="/dashboard/task/{{ $post->slug }}"  enctype="multipart/form-data">
            @method('put')
            @csrf
    ...
    <script>
        ...
        judul.addEventListener('change', function(){
            fetch('/dashboard/task/checkSlug?judul=' + judul.value)
