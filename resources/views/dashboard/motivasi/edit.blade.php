...
<div class="form-control ">
    <form method="post" action="/dashboard/motivasi/{{$motivation->slug}} " enctype="multipart/form-data">
        ...
        <div class ="w-full mb-3 mt-4">
            ...
            <input type="text" placeholder="Type here" class="input input-bordered w-10/12" id="judul" name="judul" required autofocus value="{{ old('judul', $motivation->judul) }}">
            @error('judul')
        ...
        <button class="btn btn-primary"><i data-feather="file-plus" class="mr-2 text-bwhite "></i>Update Motivasi</button>
    </form>
</div>
