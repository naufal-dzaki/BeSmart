...
<h1 class="text-3xl text-black pb-4">Membuat Motivasi</h1>

<div class="form-control ">
    <form method="post" action="/dashboard/motivasi" enctype="multipart/form-data">
        @csrf
        ...
        <button class="btn btn-primary"><i data-feather="file-plus" class="mr-2 text-bwhite "></i>Buat Motivasi</button>
    </form>
</div>
