            ...
            <div class=" w-full sm:w-1/2 lg:mb-5 md:mb-4 sm:mb-3 mb-2 px-3">
                <div class="flex bg-bwhite filter drop-shadow-md rounded-md p-2 md:p-3">
                    <div class="bg-balt px-2 py-2">
                        <img src="{{ asset('img/materi.png') }}" class=" lg:w-20 md:w-16 sm:w-14 w-12" alt="">
                    </div>
                    <div class="block">
                        <h1
                        ...
                        <div class="flex">
                            <div
                                ...
                                <p class="font-bsans md:text-base sm:text-sm text-xs font-bold text-bwhite text-center">Bab 1
                                </p>
                            </div>
                        </div>
                    </div>
